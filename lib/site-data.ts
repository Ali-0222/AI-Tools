...
export const siteTools: ToolDefinition[] = [
  {
    ...
    description:
      "Upload a photo, separate the subject from the background, and download a transparent PNG.",
  ...
  },
  {
    ...
    description: "Make large images lighter for uploads, email, forms, and web pages while previewing the result.",
  ...
  },
  {
    ...
    description: "Resize photos or graphics to exact dimensions, with an option to keep the original ratio.",
  ...
  },
  {
    ...
    description: "Turn a JPG or JPEG into a PNG when you need compatibility, sharp edges, or a different format.",
  ...
  },
  {
    ...
    description: "Convert WebP images into PNG files for apps, forms, and editors that do not accept WebP.",
  ...
  },
  {
    ...
    description:
      "Pull editable text from clear screenshots, scanned pages, and photos so you can review and copy it.",
  ...
  },
  {
    ...
    description:
      "Rewrite rough paragraphs into clearer drafts, then compare the result with your original meaning.",
  ...
  },
  {
    ...
    description: "Check words, characters, and sentences while writing essays, captions, descriptions, or notes.",
  ...
  },
  {
    ...
    description: "Clean up inconsistent capitalization for headings, labels, lists, and pasted text.",
  ...
  },
  {
    ...
    description: "Clean repeated rows from lists, keywords, IDs, notes, or copied spreadsheet text.",
  ...
  },
  {
    ...
    description: "Reverse characters, words, or lines for quick checks, text effects, and string experiments.",
  ...
  },
  {
    ...
    description: "Sort pasted lines A-Z or Z-A, with optional duplicate removal for cleaner lists.",
  ...
  },
  {
    ...
    description: "Fix extra spaces, uneven line breaks, and pasted formatting noise before editing or publishing.",
  ...
  },
  {
    ...
    description: "Turn titles and phrases into readable lowercase URL slugs for pages, posts, and docs.",
  ...
  },
  {
    ...
    description: "Encode unsafe URL values or decode copied links while checking the result before reuse.",
  ...
  },
  {
    ...
    description: "Encode small text values to Base64 or decode Base64 strings for inspection and debugging.",
  ...
  },
  {
    ...
    description: "Generate unique passwords with length and character controls, then store them safely.",
  ...
  },
  {
    ...
    description: "Create UUID v4 identifiers for test data, API examples, database rows, and logs.",
  ...
  },
  {
    ...
    description: "Calculate age in years, months, and days from a date of birth and a chosen current date.",
  ...
  },
  {
    ...
    description: "Estimate BMI from height and weight, then read the broad category with a clear limitation note.",
  ...
  },
  {
    ...
    description: "Format messy JSON, validate syntax, and copy a readable version after fixing any errors.",
  ...
  },
  {
    ...
    description:
      "Create a QR code for a URL or short text, test it, and download a PNG for sharing or print.",
  ...
  },
  {
    ...
    description: "Arrange PDF files in order and combine them into one downloadable document.",
  ...
  },
  {
    ...
    description: "Convert a DOCX document into a PDF, then check the exported layout before sharing.",
  ...
  },
  {
    ...
    slug: "cv-builder",
    shortTitle: "Build CV",
    description: "Build a structured CV from your details, preview sections live, and export a PDF when ready.",
